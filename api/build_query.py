...
def build_get_query_JSON_str(query: dict) -> str:
...
def build_get_query_date_str(query: dict) -> str:
...
def build_get_query_fields_str(query: dict) -> str:
...
def build_get_query_str(query: dict) -> str:
    ...
    fields_str = build_get_query_fields_str(query)
    query_str += fields_str

    json_str = build_get_query_JSON_str(query)
    query_str += json_str

    if json_str != '' and query.get('month'):
        query_str += 'AND '
    date_str = build_get_query_date_str(query)
    query_str += date_str
